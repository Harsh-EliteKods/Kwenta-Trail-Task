...
const TradeBalance = memo(() => {
  ...
  return (
    <Container mobile={isMobile}>
              ...
              {lockedMargin.gt(0) && (
                <StyledFlexDivCol>
                  <FlexDivRowCentered columnGap="5px">
                    ...
                    <Tooltip position="fixed" content={t('futures.market.trade.trade-balance.tooltip')} width="280px">
                      <HelpIcon />
                    </Tooltip>
                  </FlexDivRowCentered>
      ...
      {openModal === 'futures_smart_margin_socket' && <SmartMarginOnboardModal onDismiss={dismissModal} />}
    </Container>
  );
});
