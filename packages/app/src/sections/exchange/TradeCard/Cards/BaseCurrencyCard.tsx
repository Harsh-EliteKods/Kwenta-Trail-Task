...
import { selectBaseBalanceWei, selectBaseCurrencyName, selectBasePriceRateWei } from 'state/exchange/selectors';
...
const BaseCurrencyCard: FC = memo(() => {
  ...
  const { baseCurrencyKey, baseAmount, txProvider, oneInchQuoteLoading } = useAppSelector(({ exchange }) => ({
