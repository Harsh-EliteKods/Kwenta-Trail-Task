...
export const FUTURES_ENDPOINT_OP_GOERLI = 'https://api.thegraph.com/subgraphs/name/kwenta/optimism-goerli-perps';
...
export const MAIN_ENDPOINT_OP_MAINNET = 'https://api.thegraph.com/subgraphs/name/kwenta/optimism-main';

export const MAIN_ENDPOINT_OP_GOERLI = 'https://api.thegraph.com/subgraphs/name/kwenta/optimism-goerli-main';
...
export const ISOLATED_MARGIN_FRAGMENT = gql`
  query userFuturesMarginTransfers($walletAddress: String!) {
    futuresMarginTransfers(where: { account: $walletAddress }, orderBy: timestamp, orderDirection: desc, first: 1000) {
      id
      timestamp
      account
      market
